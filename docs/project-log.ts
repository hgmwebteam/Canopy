...
export const entries: LogEntry[] = [
  {
    ...
    items: [
      ...
      "UTM attribution → GHL: utm_source / utm_medium / utm_campaign / utm_content from any ad or link now persist in the browser (first touch kept forever, last touch updated per visit) and sync into the sub-account's existing UTM custom fields — both Last Attribution and First Attribution sets (utm_content fills the “UTM Ad” fields) — on every waitlist signup, checkout entry, and payment. Verified live against the GHL API.",
